 ...
 * 带测输出流
 */
public class IntervalJoinWithSideExample {
    public static void main(String[] args) throws Exception {
        ...
        OutputTag<Tuple2<String, Integer>> lateTag1 = new OutputTag<Tuple2<String, Integer>>("late1") {};
        OutputTag<Tuple3<String, Integer, Integer>> lateTag2 = new OutputTag<Tuple3<String, Integer, Integer>>("late2") {};
        ...
        SingleOutputStreamOperator<String> process = ks1.intervalJoin(ks2)
                ...
                .sideOutputLeftLateData(lateTag1)
                .sideOutputRightLateData(lateTag2)
        ...
        process.print();
        process.getSideOutput(lateTag1).print("lateTag1");
        process.getSideOutput(lateTag2).print("lateTag2");
        env.execute();
    }
}
